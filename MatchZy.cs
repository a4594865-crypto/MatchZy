...
if (matchStartCountdownTimer != null)
{
    ...
    CancelMatchCountdown($"CancelMatchCountdown($"{chatPrefix} {ChatColors.Green}{player.PlayerName} {ChatColors.White}斷開連線，倒數中止請重新輸入 {ChatColors.LightRed}.R {ChatColors.White}準備");");
