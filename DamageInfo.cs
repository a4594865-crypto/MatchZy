...
namespace MatchZy
{
    public partial class MatchZy
    {
        ...
        public void ShowSinglePlayerDamage(CCSPlayerController player)
        {
            ...
            // 準備要發送到團隊頻道的訊息格式
            string damageMessage = $"{ChatColors.BlueGrey[T]{ChatColors.Default} {ChatColors.BlueGrey}{callerName}：{ChatColors.Default} 命中 {ChatColors.Yellow}{killerName}{ChatColors.Default} 1 次 {ChatColors.LightRed}- {damageGiven}{ChatColors.Default} 傷 害";
