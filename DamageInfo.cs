...
namespace MatchZy
{
    public partial class MatchZy
    {
        ...
        public void ShowSinglePlayerDamage(CCSPlayerController player)
        {
            ...
            // 輸出格式
            player.PrintToChat($"[{ChatColors.Green}傷害報告{ChatColors.Default}] {ChatColors.LightBlue}{callerName}{ChatColors.Default} 對 {ChatColors.Gold}{killerName}{ChatColors.Default} 造 成 {ChatColors.LightRed}- {damageGiven}{ChatColors.Default} 傷 害");
        }
